...
namespace Chapter_12_Polymorphism
{
    ...
    public abstract class clsVehicle
    {
        ...
        #region methods
            ...
            //A public virtual method that may be overriden.  This method may be seen outside this class.
            public virtual void ThisIsAPublicMethod()
            {
            }

            //NOTE: This is an abstract method that must be impletemented in any derived classes //////////////////////////////////////////////
            public abstract string AbstractMethodExample(string Mystring);
